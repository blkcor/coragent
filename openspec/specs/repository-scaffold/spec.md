...
Repository structure, build hygiene, and shared vocabulary for the Coragent harness — ensures the architecture-prescribed directory layout, import discipline, build/test health, and core type definitions are in place from the first checkout.
